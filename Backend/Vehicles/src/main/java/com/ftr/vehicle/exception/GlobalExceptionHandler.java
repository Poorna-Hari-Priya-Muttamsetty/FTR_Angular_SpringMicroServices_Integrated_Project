...
public class GlobalExceptionHandler extends Exception{
    ...
    public ResponseEntity<ErrorMessage> globalExceptionHandler(Exception e) {
        ...
        error.setMessage( environment.getProperty(VehicleConstants.VEHICLE_GENERAL_EXCEPTION.toString()));
    ...
    public ResponseEntity<ErrorMessage> vehicleExceptionhandler(VehicleException e){
        ErrorMessage error = new ErrorMessage();
        error.setStatusCode(HttpStatus.BAD_REQUEST.value());
