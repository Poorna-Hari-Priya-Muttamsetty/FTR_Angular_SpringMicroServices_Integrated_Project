package com.ftr.workitem.exception;
...
public class GlobalExceptionHandler extends Exception{
    ...
    public ResponseEntity<ErrorMessage> userNotFoundExceptionhandler(WorkitemException e){
        ErrorMessage error = new ErrorMessage();
        error.setStatusCode(HttpStatus.BAD_REQUEST.value());
        error.setMessage(environment.getProperty(WorkitemConstants.WORKITEM_NOT_FOUND.toString()));
        return new ResponseEntity<>(error,HttpStatus.BAD_REQUEST);
    }
}
